/*Brute force approach - one by one compare x with every element of the matrix.
If matches, then return position. If we reach the end, return -1. The time complexity of this solution is O(nm).
Efficient Solution - Convert 2D INTO 1D ARRAY and then use binary searching.
*/
#include<iostream>
#include <bits/stdc++.h>
using namespace std;
